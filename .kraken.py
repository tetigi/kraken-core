...
python.mypy(additional_args=["--exclude", "tests/std/integration/.*/data/.*"])
python.pytest(ignore_dirs=["tests/std/integration"])
python.pytest(
    name="pytestIntegration",
    tests_dir="tests/std/integration",
    ignore_dirs=["tests/std/integration/python/data"],
